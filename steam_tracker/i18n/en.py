...
STRINGS: dict[str, str] = {
    ...
    # ── CLI – sidecar serve ─────────────────────────────────────────────────
    "cli_serve_url": "🌐 SteamPulse live at http://localhost:{port}/",
    "cli_serve_stop": "   Press Ctrl+C to stop.",
    "cli_serve_steamid_missing": "   ⚠ --steamid not provided: HTML pages will not be re-rendered.",
    "cli_serve_token_set": "   \U0001f512 Auth enabled \u2014 browse to /login to sign in.",
    # ── HTML – sidecar action buttons ────────────────────────────────────
    "btn_mark_removed_tooltip": "Mark as removed from store",
    "btn_reactivate_tooltip": "Reactivate (game is available again)",
    "btn_delete_tooltip": "Permanently delete from database",
    ...
    "cli_pending": ("   {details} game(s) to fetch · {news} news to refresh ({cached} up to date)"),
    "cli_interrupted": "\nInterrupted.",
    "cli_wizard_done": (
    ...
    "lbl_15_days": "15 days",
    "lbl_30_days": "30 days",
    "footer": ("SteamPulse · Data via Steam Web API &amp; Store API · Not affiliated with Valve"),
    # ── HTML – library page ───────────────────────────────────────────────────
